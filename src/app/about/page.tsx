      ...
      <main>
        <section style={{ marginBottom: "3rem" }}>
          <p style={{ fontSize: "1.25rem", lineHeight: 1.65 }}>
            I used to think expertise meant knowing more than everyone else in
            the room. Now I think it means knowing which questions to ask—and
            which tools extend your reach.
          </p>
