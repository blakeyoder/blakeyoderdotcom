  ...
  const tutorialSteps = [
    {
      ...
      content:
        "You're now in vim mode! This entire page has become your vim editor. Notice the status bar at the bottom showing you're in NORMAL mode.",
    ...
    },
    {
      title: "Insert Mode",
      content:
        "Press 'i' to enter INSERT mode. You can then type anywhere in this text. The status bar will change to show INSERT mode.",
    ...
    },
    {
      title: "Navigation",
      content:
        "Use 'h', 'j', 'k', 'l' to move left, down, up, right. Try moving around this text!",
    ...
    },
    {
      ...
      content:
        "I use Space as my leader key. Try 'Space + w' to save. You'll see a message in the status bar.",
    ...
    },
    {
      ...
      content:
        "Try 'dd' to delete an entire line, or 'x' to delete a single character. These only work in normal mode!",
    ...
    },
    {
      ...
      content:
        "Try my custom 'Space + 4' to jump to the end of the current line. Much faster than holding the right arrow!",
    ...
    },
    {
      title: "Free Practice",
      content:
        "You've learned the basics! Practice editing this text. Try different combinations of commands. Press 'Finish' when you're done.",
      ...
      <main>
        <section style={{ marginBottom: "3rem" }}>
          <p>
            ...
            . One day, I quit Sublime Text cold turkey and dove straight into
            vim. For the first two weeks, it felt like coding with one arm tied
            behind my back—every keystroke was friction, every task took twice
            as long.
          </p>

          <p>
            Then, around week three, something clicked. The motions stopped
            feeling foreign, and I started to see patterns: Vim wasn&apos;t just
            a text editor, it was a language. Key bindings were verbs and
            modifiers, each combining into concise ways of expressing intent.
          </p>

          <p>
            Almost ten years later, that way of thinking is second nature. I use
            Vim bindings everywhere, and with the rise of agentic coding tools,
            the payoff has only grown. A tool like{" "}
            <a
            ...
            in the terminal feels like it was made for this—fast, fluid, and
            effortless in a way I could only dream of back in those first
            awkward weeks.
          </p>

          <p>
            If you want to learn the dialect I speak, my{" "}
            <a
            ...
            is right here for you to borrow, steal, or adapt. Not ready to go
            all-in? You can still hop into Vim mode on this site and try some of
            my favorite keybindings here—no commitment.
          </p>
        </section>
        ...
        >
          ...
          <button onClick={enterVimMode} className="btn">
            Enter Vim Mode
          </button>
