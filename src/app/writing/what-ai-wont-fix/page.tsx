...
export const metadata: Metadata = {
  ...
  description: "Everyone's obsessing over what AI changes. The more interesting question: what doesn't it change at all?",
  openGraph: {
  ...
  return (
    <div className="container">
      ...
      <header style={{ marginBottom: "2rem" }}>
        ...
        <p className="article-date" style={{ marginBottom: "1rem" }}>November 28, 2025</p>
